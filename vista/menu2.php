...
<header>
		<div class="contenedor">
			...
			<!--FIN MENU-->
				<nav class="menu">
				<a href="listar_trabajador_log.php"><img src="../im/ico-bstra.png" title="Buscar Trabajador" style="width:30px"><span class="letramen"> Buscar Trabajador</span></a>
				<a href="listar_trabajo_log.php"><img src="../im/ico-bu.png" title="Buscar Trabajo" style="width:30px"><span class="letramen"> Buscar Trabajo </span></a>
				<a href="publicar_trabajo.php"><img src="../im/ico-brtr.png" title="Publicar Trabajo" style="width:30px"><span class="letramen"> Publicar Trabajo</span></a>
				<a href="aniadirOficio.php"><img src="../im/ico-list.png" title="Añadir Oficio" style="width:30px"><span class="letramen"> Añadir Oficio</span></a>
  	...
  	<div class="modal-dialog">
          ...
          <center> <a href="perfil.php?dni=<?php echo $_SESSION['dni'];?>"><span class="edit glyphicon glyphicon-cog" >Ver.Perfil</a> </span>
            ...
            <a href="../index.php?cerrar=session"  title="Editar Perfil">
                <span class="glyphicon glyphicon-log-out"title="Cerrar Session">Cerrar.Sesión</span>
            </a> 
            </center> 
